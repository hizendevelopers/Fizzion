...
export default async function TvChannelsPage() {
  ...
  const uploadedClipAds: TvDashboardAd[] = [
    {
      id: "ary-news-upload-bonus-02",
      brand: "Bonus",
      productOrCampaign: "Bonus Chocolate Reward",
      campaign: "Bonus Chocolate Reward",
      channel: "ARY News",
      category: "commercial",
      detectedAt: "2026-07-24T10:08:00.000Z",
      startTimeLabel: toDateLabel("2026-07-24T10:08:00.000Z"),
      endTimeLabel: toDateLabel(plusDuration("2026-07-24T10:08:00.000Z", 12395)),
      durationMs: 12395,
      ...
      timeSlot: toTimeSlot("2026-07-24T10:08:00.000Z"),
      dateKey: "2026-07-24",
    ...
    {
      id: "ary-news-upload-lifebuoy-01",
      brand: "Lifebuoy",
      productOrCampaign: "Lifebuoy Germ Protection",
      campaign: "Lifebuoy Germ Protection",
      channel: "ARY News",
      category: "commercial",
      detectedAt: "2026-07-24T10:22:00.000Z",
      startTimeLabel: toDateLabel("2026-07-24T10:22:00.000Z"),
      endTimeLabel: toDateLabel(plusDuration("2026-07-24T10:22:00.000Z", 23464)),
      durationMs: 23464,
      ...
      timeSlot: toTimeSlot("2026-07-24T10:22:00.000Z"),
      dateKey: "2026-07-24",
      reportUrl: "/tv/channels",
      source: "uploaded",
      ...
      ingestionLabel: "Manual clip ingestion",
      analysisSummary:
        "Imported from a user-supplied monitoring clip and assigned to the ARY News detection window. The platform generated a playable preview, a thumbnail frame, and a structured commercial report using verified file metadata.",
    },
    {
      ...
      channel: "ARY News",
      category: "commercial",
      detectedAt: "2026-07-24T10:41:00.000Z",
      startTimeLabel: toDateLabel("2026-07-24T10:41:00.000Z"),
      endTimeLabel: toDateLabel(plusDuration("2026-07-24T10:41:00.000Z", 17705)),
      durationMs: 17705,
      ...
      timeSlot: toTimeSlot("2026-07-24T10:41:00.000Z"),
      dateKey: "2026-07-24",
      reportUrl: "/tv/channels",
      source: "uploaded",
  ...
  const channelCards: TvDashboardChannel[] = [
    ...
    },
    {
      ...
      notes: "Connected newsroom watchlist channel ready for future detections.",
    },
    {
      id: "hum-news",
      name: "Hum News",
