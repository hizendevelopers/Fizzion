...
export function Sidebar({ labels }: SidebarProps) {
  ...
  return (
    <aside className="relative hidden h-full w-[10.45rem] shrink-0 self-stretch overflow-hidden border-r border-white/10 bg-[linear-gradient(180deg,#09090f_0%,#090810_38%,#0b0811_68%,#16070a_100%)] text-[#F6F7FB] lg:sticky lg:top-0 lg:flex">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[11.5rem] bg-[url('/assets/header-splash-background.svg')] bg-[length:235%_auto] bg-bottom bg-no-repeat opacity-[0.9]" />
      ...
      <div className="relative flex h-full min-h-0 w-full flex-col gap-4 px-3 pb-4 pt-5">
        <div className="px-0">
          <SidebarBranding />
        </div>
              ...
              <div key={item.href} className="space-y-2">
                {hasChildren ? (
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center justify-between rounded-[0.95rem] px-2.5 py-2.5 text-left text-[0.88rem] font-semibold leading-[1.15] transition duration-300",
                      active || isOpen
                  ...
                  >
                    <span className="flex min-w-0 items-center gap-2.5">
                      <span className={cn("flex h-[2.15rem] w-[2.15rem] shrink-0 items-center justify-center rounded-[0.82rem]", active || isOpen ? "bg-white/14" : "bg-white/6 text-white/92 shadow-[0_8px_16px_rgba(0,0,0,0.16)]")}>
                        {icon}
                      </span>
                  ...
                  <Link
                    href={item.href}
                    className={cn(
                      "flex items-center gap-2.5 rounded-[0.95rem] px-2.5 py-2.5 text-[0.88rem] font-semibold leading-[1.15] transition duration-300",
                      active
                        ? "bg-[linear-gradient(135deg,#ff5343_0%,#ff241f_52%,#f40009_100%)] text-white shadow-[0_16px_28px_rgba(244,0,9,0.34)] ring-1 ring-white/16"
                        : "text-white/92 hover:bg-white/5 hover:text-white",
                    )}
                  >
                    <span className={cn("flex h-[2.15rem] w-[2.15rem] shrink-0 items-center justify-center rounded-[0.82rem]", active ? "bg-white/14" : "bg-white/6 text-white/92 shadow-[0_8px_16px_rgba(0,0,0,0.16)]")}>
                      {icon}
                    </span>
                    <span className="block min-w-0 text-left">{labels[item.key] ?? item.key}</span>
                  </Link>
                ...
                {hasChildren && isOpen ? (
                  <div className="space-y-1.5 ps-2.5">
                    {children.map((child) => {
                      ...
                      return (
                        <Link
                          ...
                          href={child.href}
                          className={cn(
                            "flex items-center gap-2.5 rounded-[0.9rem] px-2.5 py-2 text-[0.8rem] leading-[1.2] transition duration-300",
                            childActive
        ...
        <div className="mt-auto rounded-[1.2rem] border border-white/14 bg-[linear-gradient(135deg,rgba(255,255,255,0.09)_0%,rgba(255,255,255,0.04)_100%)] px-3 py-3.5 shadow-[0_16px_30px_rgba(0,0,0,0.28)] backdrop-blur-sm">
          ...
          <p className="mt-2 text-center text-[10px] font-medium tracking-[0.02em] text-white/58">
            Built by Hizen
          </p>
        </div>
      </div>
