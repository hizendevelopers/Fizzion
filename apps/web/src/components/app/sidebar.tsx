...
export function Sidebar({ labels }: SidebarProps) {
  ...
  return (
    <aside className="hidden h-[calc(100vh-1.5rem)] w-[17rem] shrink-0 self-start border-r border-[#8d241d] bg-[#6f1712] text-sidebar-foreground lg:sticky lg:top-0 lg:flex">
