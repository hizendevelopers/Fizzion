...
function BottleIllustration({
  ...
  return (
    <svg className="mx-auto h-[410px] w-full max-w-[264px]" fill="none" viewBox="0 0 220 360">
      <defs>
        ...
        <radialGradient id={shadowId} cx="0" cy="0" gradientTransform="translate(110 334) rotate(90) scale(14 80)" gradientUnits="userSpaceOnUse">
        ...
        <clipPath id={clipId}>
          <path d="M66 42 H154 C166 42 176 51 176 62 V286 C176 303 162 316 145 316 H75 C58 316 44 303 44 286 V62 C44 51 54 42 66 42 Z" />
        </clipPath>
      </defs>

      <ellipse cx="110" cy="334" fill={`url(#${shadowId})`} rx="84" ry="14" />
      ...
      <g clipPath={`url(#${clipId})`}>
        ...
        <path d="M59 60 C54 102 53 236 66 300" stroke={`url(#${highlightId})`} strokeLinecap="round" strokeWidth="12" />
        <path d="M161 60 C167 112 167 226 157 296" stroke="rgba(255,255,255,0.12)" strokeLinecap="round" strokeWidth="5" />
      </g>
