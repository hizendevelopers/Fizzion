-- FizZion complete Supabase database schema
-- This file contains the full PostgreSQL schema for the platform, including:
-- - core identity, RBAC, and organizations
-- - brand, campaign, and creative asset management
-- - TV, social, web, and OOH monitoring
-- - reporting, alerts, retention, and operational jobs
